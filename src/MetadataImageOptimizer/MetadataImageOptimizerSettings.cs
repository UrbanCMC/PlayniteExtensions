...
namespace MetadataImageOptimizer
{
    public class MetadataImageOptimizerSettings : ObservableObject
    {
        ...
        private string backgroundFormat = "jpg";
        ...
        public string BackgroundFormat { get => backgroundFormat; set => SetValue(ref backgroundFormat, value); }
        ...
        public string CoverFormat { get => coverFormat; set => SetValue(ref coverFormat, value); }
        ...
        public string IconFormat { get => iconFormat; set => SetValue(ref iconFormat, value); }
